...
function initializeCarousel(currentSlug) {
	...
	const extendedJuices = [...filteredJuices, ...filteredJuices, ...filteredJuices, ...filteredJuices, ...filteredJuices, ...filteredJuices, ...filteredJuices, ...filteredJuices, ...filteredJuices];
